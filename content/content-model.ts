...
export interface Exercise {
  ...
  // Spoken version of `hint`, per language, so the tip is audio-first (a text
  // hint is useless to the pre-reader it's meant to help). Kept in step with
  // `hint` by the content check; generated by scripts/generate-audio.mjs.
  hintAudio?: Record<LangCode, AudioClip>;
      ...
      exercises: [
        {
          ...
          hintAudio: {
            bg: { src: "audio/bg/hint/apple__default.mp3", voiceId: "default" },
            en: { src: "audio/en/hint/apple__default.mp3", voiceId: "default" },
          },
        },
      ...
      exercises: [
        {
          ...
          hintAudio: {
            bg: { src: "audio/bg/hint/cat__default.mp3", voiceId: "default" },
            en: { src: "audio/en/hint/cat__default.mp3", voiceId: "default" },
          },
        },
  ...
  lessons: [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          hintAudio: {
            bg: { src: "audio/bg/hint/bread__default.mp3", voiceId: "default" },
            en: { src: "audio/en/hint/bread__default.mp3", voiceId: "default" },
          },
        },
  ...
  lessons: [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          hintAudio: {
            bg: { src: "audio/bg/hint/house__default.mp3", voiceId: "default" },
            en: { src: "audio/en/hint/house__default.mp3", voiceId: "default" },
          },
        },
  ...
  lessons: [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          hintAudio: {
            bg: { src: "audio/bg/hint/shirt__default.mp3", voiceId: "default" },
            en: { src: "audio/en/hint/shirt__default.mp3", voiceId: "default" },
          },
        },
  ...
  lessons: [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          hintAudio: {
            bg: { src: "audio/bg/hint/ball__default.mp3", voiceId: "default" },
            en: { src: "audio/en/hint/ball__default.mp3", voiceId: "default" },
          },
        },
